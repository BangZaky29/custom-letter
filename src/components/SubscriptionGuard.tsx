...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'custom-letter'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'custom-letter') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'custom-letter'): boolean => {
    try {
